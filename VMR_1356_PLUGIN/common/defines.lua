...
NCountry = {
	...
	WESTERNISATION_THRESHOLD = 10,					-- techs behind to be allowed to westernize.
...
NAI = {
	...
	NUM_GREAT_POWER_ALLIES_ALLOWED = 1, -- Number of Great Power allies allowed before a penalty is applied to alliance chance
